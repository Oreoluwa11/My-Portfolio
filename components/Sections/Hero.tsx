...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center md:py-20 py-1 px-4 sm:px-6 lg:px-8 
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 ">
        <div className="mb-8 slide-up mt-20 md:mt-1">
          <div className="w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 mx-auto mb-6 rounded-full overflow-hidden ring-purple-bright/20 shadow-glow ">
            <Image
              src="/dp.svg"
              alt="Profile Picture"
              width={256}
        ...
        <p className="text-lg text-[hsl(0_0%_70%)] max-w-2xl mx-auto mb-12 slide-up delay-300">
          ...
          modern technologies. I turn ideas into interactive digital solutions.
        </p>
